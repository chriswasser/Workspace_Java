...
public class MastermindGUI extends JFrame {
	...
	public MastermindGUI() {
		...
		Colour1.setOpaque(true);
		Colour1.setVisible(true);
		Colour1.setBorderPainted(false);
		...
		Colour2.setOpaque(true);
		Colour2.setVisible(true);
		Colour2.setBorderPainted(false);
		...
		Colour3.setOpaque(true);
		Colour3.setVisible(true);
		Colour3.setBorderPainted(false);
		...
		Colour4.setOpaque(true);
		Colour4.setVisible(true);
		Colour4.setBorderPainted(false);
		...
		Colour5.setOpaque(true);
		Colour5.setVisible(true);
		Colour5.setBorderPainted(false);
		...
		Colour6.setOpaque(true);
		Colour6.setVisible(true);
		Colour6.setBorderPainted(false);
		...
		Colour7.setBackground(Color.DARK_GRAY);
		Colour7.setOpaque(true);
		Colour7.setVisible(true);
		Colour7.setBorderPainted(false);
		...
		Colour8.setOpaque(true);
		Colour8.setVisible(true);
		Colour8.setBorderPainted(false);

		getSoluBtn = new JButton("Set Solution");
		getSoluBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				start();
			}
		});
		getSoluBtn.setBounds(290, 650, 165, 40);
		contentPane.add(getSoluBtn);
		...
		GuessBtn.setBounds(290, 700, 165, 40);
		...
		playAgainBtn.setBounds(290, 650, 165, 40);
		...
		playCompBtn.setBounds(290, 700, 165, 40);
